            ...
            <div className="container max-w-[1140px] mx-auto px-4">
                ...
                <div className="flex flex-wrap xl:justify-between justify-center md:gap-[77px] gap-[50px] pt-10 items-center">
                    <div className='flex flex-wrap justify-center md:gap-[61px] gap-[40px]'>
                        <div>
                            <p className='md:text-customLg text-5xl font-normal text-dark-orange max-sm:text-center'><span>+</span>155</p>
                            <p className='font-bold md:text-[21px] text-lg whitespace-nowrap'>Ideas submitted</p>
                        </div>
                        <div>
                            <p className='md:text-customLg text-5xl font-normal text-dark-orange max-sm:text-center'>+325</p>
                            <p className='font-bold md:text-[21px] text-lg whitespace-nowrap'>Active Platform users</p>
                        </div>
                        <div>
                            <p className='md:text-customLg text-5xl font-normal text-dark-orange max-sm:text-center'>+250</p>
                            <p className='font-bold md:text-customSm text-lg whitespace-nowrap'>Community Members</p>
                        </div>
                    </div>
                    <CustomButton text="Submit Your idea!" myClass="!text-red max-lg:!mx-auto !flex border-2 md:!px-[50px] md:!py-[10.4px] px-[43.6px] py-[7px] !border-red hover:!bg-red hover:!text-white" />
                </div>
            </div>
        </div>
    )
