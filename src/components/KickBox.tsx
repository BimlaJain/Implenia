                ...
                <div className="flex flex-wrap xl:justify-between justify-center md:gap-[77px] gap-[50px] pt-10 items-center">
                    ...
                    >
                        {STATS.map((item, index) => (
                            ...
                            >
                                <h3 className="text-customLg max-lg:text-7xl max-md:text-6xl max-sm:text-5xl max-lg:leading-[92px] max-md:leading-[80px] max-sm:leading-[60px] leading-[100px] text-light-orange tracking-[-0.66px]">
                                    +
                                    <CountUp
                                        start={0}
                                        end={
