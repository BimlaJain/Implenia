...
const Hero = () => {
    return (
        <div id='home' className='bg-center bg-cover bg-no-repeat relative pb-20 overflow-hidden' style={{ backgroundImage: `url(/assets/images/webp/hero-bg.webp)` }}>
            <Header />
            <img data-aos="fade-right" className=' absolute  md:top-[45%] top-[61%] lg:w-[450px] lg:h-[402px] md:size-[350px] size-[200px]' src="../assets/images/webp/dustbin.webp" alt="dustbin" />
