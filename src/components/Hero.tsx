...
const Hero = () => {
    return (
        <div id='home' className='bg-center  bg-cover  bg-no-repeat relative pb-16 overflow-hidden bg-hero-bg-image' >
            <Header />
            <img data-aos="fade-right" className=' absolute  lg:top-[47%] md:top-[42%] top-[47%] lg:w-[450px] lg:h-[402px] md:size-[350px] size-[200px]' src="../assets/images/webp/dustbin.webp" alt="dustbin" />
            <div className="container max-w-[1172px] mx-auto px-4 relative z-20 max-sm:bg-black/20">
                <div className="flex flex-col xl:pt-[350px] lg:pt-[330px] md:pt-[290px] pt-[150px] xl:pl-5 relative z-20 ">
